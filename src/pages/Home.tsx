      ...
      <div className="absolute inset-0 z-10">
        <div className="min-h-screen flex flex-col justify-center items-center px-4 text-white">
          <div className="max-w-4xl text-center space-y-6">
            <div className="mb-8">
              <div className="w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden border-4 border-blue-900 shadow-xl">
                <img
                  src="/profile.jpg"
              ...
              <h2 className="text-2xl md:text-3xl text-blue-500">
            ...
            <div className="flex justify-center space-x-8 mt-12">
              {skills.map((skill, index) => (
                <div
                  key={index}
                  className="bg-black/30 backdrop-blur-sm p-6 rounded-lg w-64 transform hover:scale-105 transition-transform duration-300 border border-blue-900/30"
                >
